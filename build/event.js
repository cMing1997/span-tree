...
/***/ "./event/src/reducers/API/searchTerms.js":
/*!***********************************************!*\
  !*** ./event/src/reducers/API/searchTerms.js ***!
  \***********************************************/
...
var _API = __webpack_require__(/*! ../../types/API */ "./event/src/types/API.js");
...
exports.default = function () {
  ...
  switch (action.type) {
    case _API.FETCH_SEARCH_TERMS:
      return _extends({}, state, _defineProperty({}, action.reducerDetails.repoName, _extends({}, state[action.reducerDetails.repoName], _defineProperty({}, action.reducerDetails.branchName, action.payload))));
    default:
      return state;
  }
};
...
/***/ "./event/src/reducers/API/tree.js":
/*!****************************************!*\
  !*** ./event/src/reducers/API/tree.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _immer = __webpack_require__(/*! immer */ "./node_modules/immer/dist/immer.esm.js");
...
exports.default = function () {
  ...
  switch (action.type) {
    case _API.FETCH_TREE:
      return _extends({}, state, _defineProperty({}, action.reducerDetails.tabId, action.payload.map(function (node) {
        return {
          name: node.name,
          path: node.path.split("/").filter(function (pathSub) {
            return pathSub.length !== 0;
          }),
    ...
    case _API.OPEN_DIR:
      var objectPath = [action.reducerDetails.tabId];
      ...
      objectPath = [].concat(_toConsumableArray(objectPath), ["isTree", "isOpen"]);
      var propName = objectPath.pop();

      var nextState = (0, _immer2.default)(state, function (draft) {
        draft = objectPath.reduce(function (it, prop) {
          return it[prop];
        }, draft);
        draft[propName] = true;
      });
      return nextState;
    case _API.UPDATE_TREE:
      objectPath = [action.reducerDetails.tabId];
      for (var _i = 0; _i < action.reducerDetails.path.length; _i++) {
        objectPath.push(action.reducerDetails.path[_i]);
        if (_i !== action.reducerDetails.path.length - 1) {
          objectPath.push("children");
        }
      }
      ...
      var children = action.payload.map(function (node) {
        return {
          name: node.name,
          path: node.path.split("/").filter(function (pathSub) {
            return pathSub.length !== 0;
      ...
      nextState = (0, _immer2.default)(state, function (draft) {
        draft = objectPath.reduce(function (it, prop) {
          return it[prop];
        }, draft);
    ...
    case _API.CLOSE_DIR:
      objectPath = [action.reducerDetails.tabId];
      for (var _i2 = 0; _i2 < action.payload.length; _i2++) {
        objectPath.push(action.payload[_i2]);
        if (_i2 !== action.payload.length - 1) {
          objectPath.push("children");
        }
      }
...
/***/ "./event/src/reducers/UI/clicked.js":
/*!******************************************!*\
  !*** ./event/src/reducers/UI/clicked.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _UI = __webpack_require__(/*! ../../types/UI */ "./event/src/types/UI.js");
...
exports.default = function () {
  ...
  switch (action.type) {
    case _UI.TOGGLE_OPENED:
      return _extends({}, state, _defineProperty({}, action.reducerDetails.tabId, action.reducerDetails.tabId in state ? !state[action.reducerDetails.tabId] : true));
    default:
      return state;
  }
};
...
/***/ "./event/src/reducers/UI/options.js":
/*!******************************************!*\
  !*** ./event/src/reducers/UI/options.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var initialState = JSON.parse(localStorage.getItem("spantree-options")) || {};
...
/***/ "./event/src/reducers/UI/pinned.js":
/*!*****************************************!*\
  !*** ./event/src/reducers/UI/pinned.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./event/src/reducers/UI/width.js":
/*!****************************************!*\
  !*** ./event/src/reducers/UI/width.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.default = function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialWidth;
  var action = arguments[1];
...
var _opened = __webpack_require__(/*! ./UI/opened */ "./event/src/reducers/UI/opened.js");

var _opened2 = _interopRequireDefault(_opened);

var _pinned = __webpack_require__(/*! ./UI/pinned */ "./event/src/reducers/UI/pinned.js");

var _pinned2 = _interopRequireDefault(_pinned);

var _width = __webpack_require__(/*! ./UI/width */ "./event/src/reducers/UI/width.js");

var _width2 = _interopRequireDefault(_width);

var _clicked = __webpack_require__(/*! ./UI/clicked */ "./event/src/reducers/UI/clicked.js");

var _clicked2 = _interopRequireDefault(_clicked);

var _options = __webpack_require__(/*! ./UI/options */ "./event/src/reducers/UI/options.js");

var _options2 = _interopRequireDefault(_options);

var _tree = __webpack_require__(/*! ./API/tree */ "./event/src/reducers/API/tree.js");

var _tree2 = _interopRequireDefault(_tree);

var _searchTerms = __webpack_require__(/*! ./API/searchTerms */ "./event/src/reducers/API/searchTerms.js");
...
exports.default = (0, _redux.combineReducers)({
  opened: _opened2.default,
  pinned: _pinned2.default,
  width: _width2.default,
  clicked: _clicked2.default,
...
var FETCH_TREE = exports.FETCH_TREE = "FETCH_TREE";
var UPDATE_TREE = exports.UPDATE_TREE = "UPDATE_TREE";

var OPEN_DIR = exports.OPEN_DIR = "OPEN_DIR";
var CLOSE_DIR = exports.CLOSE_DIR = "CLOSE_DIR";

var FETCH_SEARCH_TERMS = exports.FETCH_SEARCH_TERMS = "FETCH_SEARCH_TERMS";

/***/ }),

/***/ "./event/src/types/UI.js":
/*!*******************************!*\
  !*** ./event/src/types/UI.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, exports) => {
...
var TOGGLE_PINNED = exports.TOGGLE_PINNED = "TOGGLE_PINNED";
var TOGGLE_OPENED = exports.TOGGLE_OPENED = "TOGGLE_OPENED";

var SET_WIDTH = exports.SET_WIDTH = "SET_WIDTH";

var SET_CLICKED = exports.SET_CLICKED = "SET_CLICKED";

var OPTIONS_CHANGED = exports.OPTIONS_CHANGED = "OPTIONS_CHANGED";

/***/ }),

/***/ "./node_modules/chrome-tab-identifier/lib/index.js":
/*!*********************************************************!*\
  !*** ./node_modules/chrome-tab-identifier/lib/index.js ***!
  \*********************************************************/
/***/ (function(module) {
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (function(modules) {
    ...
    /******/
    /******/
    /******/ /******/ __nested_webpack_require_623__.m = modules; // expose the module cache
    /******/
    /******/ /******/ __nested_webpack_require_623__.c = installedModules; // define getter function for harmony exports
    /******/
    ...
    /******/
    /******/ /******/ __nested_webpack_require_623__.o = function(object, property) {
      return Object.prototype.hasOwnProperty.call(object, property);
    }; // __webpack_public_path__
    /******/
    /******/ /******/ __nested_webpack_require_623__.p = ""; // Load entry module and return exports
    /******/
    /******/ /******/ return __nested_webpack_require_623__((__nested_webpack_require_623__.s = 0));
    /******/
  })(
    /************************************************************************/
    /******/ [
...
function getBrowserAPI() {
  ...
  try {
    api = __webpack_require__.g.chrome || __webpack_require__.g.browser || browser;
  } catch (error) {
    api = browser;
  }
...
var _reducers = __webpack_require__(/*! ./reducers */ "./event/src/reducers/index.js");

var _reducers2 = _interopRequireDefault(_reducers);

var _chromeTabIdentifier = __webpack_require__(/*! chrome-tab-identifier */ "./node_modules/chrome-tab-identifier/lib/index.js");

var _webextRedux = __webpack_require__(/*! webext-redux */ "./node_modules/webext-redux/lib/index.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var tabIdentifier = new _chromeTabIdentifier.TabIdentifier();

var store = (0, _redux.createStore)(_reducers2.default, {});

(0, _webextRedux.wrapStore)((0, _webextRedux.applyMiddleware)(store, _reduxThunk2.default));
})();
